...
import com.omar.sparkmessenger.Adapter.ChatAdapter;
import com.omar.sparkmessenger.Models.ChatMessage;
import com.omar.sparkmessenger.Models.User;
import com.omar.sparkmessenger.Network.ApiClient;
import com.omar.sparkmessenger.Network.ApiService;
...
import com.omar.sparkmessenger.databinding.ActivityChatBinding;
...
public class Chat_Activity extends BaseActivity {
    ...
    private void sendMessage(){
        if (!binding.inputMessage.getText().toString().isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(), R.string.type_a_message, Toast.LENGTH_SHORT).show();
        }
    }
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).document(receiverUser.id)
                .addSnapshotListener(Chat_Activity.this, (value, error) -> {
                    ...
                    if (isReceiverAvailable){
                        ...
                        binding.textAvailability.setText(R.string.offline);
                    }
                });
    }
